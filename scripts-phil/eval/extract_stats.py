...
parser.add_argument('--sims', default='/home/na469/phil/gem5-mesh/results', help='Path with results you want to analyze')
parser.add_argument('--outfile', default='/home/na469/phil/gem5-mesh/results/extract.csv', help='CSV Path where extracted data should go')
