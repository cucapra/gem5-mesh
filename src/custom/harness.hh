// modded from learning_gem5/part2/simple_cache.hh
...
/**
 * A test harness to plug into anything but specifically cpu
 * to test the new ports
 */
class Harness : public ClockedObject
{
  private:
    ...
    std::vector<CPUSideSlavePort> slavePorts;

    /// Instantiation of the memory-side port
    std::vector<CPUSideMasterPort> masterPorts;
